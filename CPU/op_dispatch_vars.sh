...
############################################
OP_SUBMISSION_VAR01_FILE="./src/loop_restructure/tuned_variant01_op.c"
OP_SUBMISSION_VAR02_FILE="./src/loop_restructure/tuned_variant02_op.c"
OP_SUBMISSION_VAR03_FILE="./src/loop_restructure/tuned_variant03_op.c"
